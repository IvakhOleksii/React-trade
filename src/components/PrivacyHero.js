          ...
          <Row className="d-flex justify-content-center align-items-center  pt-4 pb-4">
            <Col className=" p-3 mb-2" lg={12} md={12} sm={12}>
              <h1 className="trade-your-car-heading">
                Privacy
                <span className="d-inline trader-sell-text pl-2">Policy</span>
              </h1>
              <p className="pt-3">
            ...
            <Col lg={12} md={12} sm={12}>
              ...
              <p>
                {" "}
                Note that TraderSell.com has no access to or control over these
                cookies that are used by third-party advertisers.{" "}
              </p>
              <h3 className="pt-1"> Third-Party Privacy Policies</h3>
              <p>
                {" "}
                TraderSell.com's Privacy Policy does not apply to other
              ...
              <p>
                {" "}
                TraderSell.com follows a standard procedure of using log files.
              ...
              <p>
                Like any other website, TraderSell.com uses ‘cookies'. These
              ...
              <p>
                ...
                visitors based upon their visit to www.tradersell.com and other
              ...
              <p>
                ...
                their Privacy Policies below. • Google
                https://policies.google.com/technologies/ads.
              </p>
              ...
              <p>
                ...
                the advertising partners of TraderSell.com.
              </p>
              <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on
                TraderSell.com, which are sent directly to users' browser. They
              ...
              <p>
                TraderSell.com does not knowingly collect any Personal
